...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nameTextView = (TextView) listItemView.findViewById(R.id.ikale_text_view);
        // Get the Miwok translation from the current Word object and
        // set this text on the name TextView
        nameTextView.setText(currentWord.getmIkaleTranslation());

        // Find the TextView in the list_item.xml layout with the ID default_translation
        TextView numberTextView = (TextView) listItemView.findViewById(R.id.default_text_view);
        // Get the default translation from the current AndroidFlavor object and
